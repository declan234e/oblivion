...
import gmz.reactors.item.UrandiaIngotItem;
import gmz.reactors.AtlasMultiModElements;
import gmz.reactors.AtlasMultiMod;

@AtlasMultiModElements.ModElement.Tag
public class TinyReactorGuiGui extends AtlasMultiModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public TinyReactorGuiGui(AtlasMultiModElements instance) {
		super(instance, 16);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 14, 21) {
				@Override
				...
				this.addSlot(new Slot(inv, si, 0 + 8 + si * 18, 0 + 142));
			{
				...
				ReactorGUIOpenProcedure.executeProcedure($_dependencies);
			}
		}
