...
import gmz.reactors.procedures.TinyReactorUpdateTickProcedure;
import gmz.reactors.procedures.TinyReactorState1BlockAddedProcedure;
import gmz.reactors.itemgroup.ReactorsItemGroup;
import gmz.reactors.gui.TinyReactorGuiGui;
...
public class TinyReactorState1Block extends AtlasMultiModElements.ModElement {
	@ObjectHolder("atlas_multi:tiny_reactor_state_1")
	public static final Block block = null;
	@ObjectHolder("atlas_multi:tiny_reactor_state_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public TinyReactorState1Block(AtlasMultiModElements instance) {
		super(instance, 17);
