...
import ga.gamer234emp.obv.block.MatterFabBlock;
...
public class OblivionModBlocks {
	public static final DeferredRegister<Block> REGISTRY = DeferredRegister.create(ForgeRegistries.BLOCKS, OblivionMod.MODID);
	...
	public static final RegistryObject<Block> MATTER_FAB = REGISTRY.register("matter_fab", () -> new MatterFabBlock());
