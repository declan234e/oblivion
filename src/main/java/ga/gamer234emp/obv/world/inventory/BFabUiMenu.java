...
package ga.gamer234emp.obv.world.inventory;
...
public class BFabUiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BFabUiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(OblivionModMenus.B_FAB_UI, id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 55, 16) {
		}));
