...
public class WaterPurifierUiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WaterPurifierUiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(OblivionModMenus.WATER_PURIFIER_UI, id);
