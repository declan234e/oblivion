...
public class SnowGlobeUiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SnowGlobeUiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(OblivionModMenus.SNOW_GLOBE_UI, id);
