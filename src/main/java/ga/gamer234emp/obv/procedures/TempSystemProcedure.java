...
public class TempSystemProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
			...
			if (new Object() {
			...
			}.getValue(world, new BlockPos(x, y, z), "numOfUrandia") == 0) {
			...
			}.getValue(world, new BlockPos(x, y, z), "numOfUrandia") == 1 && new Object() {
				public double getValue(LevelAccessor world, BlockPos pos, String tag) {
					BlockEntity blockEntity = world.getBlockEntity(pos);
					if (blockEntity != null)
						return blockEntity.getTileData().getDouble(tag);
				...
				if (!world.isClientSide()) {
					...
					if (_blockEntity != null)
						...
						}.getValue(world, new BlockPos(x, y, z), "temperature") + 25));
					if (world instanceof Level _level)
						_level.sendBlockUpdated(_bp, _bs, _bs, 3);
				}
			} else if (new Object() {
			...
			}.getValue(world, new BlockPos(x, y, z), "numOfUrandia") == 2 && new Object() {
				public double getValue(LevelAccessor world, BlockPos pos, String tag) {
					BlockEntity blockEntity = world.getBlockEntity(pos);
					if (blockEntity != null)
						return blockEntity.getTileData().getDouble(tag);
			...
			}.getValue(world, new BlockPos(x, y, z), "numOfUrandia") == 3 && new Object() {
				public double getValue(LevelAccessor world, BlockPos pos, String tag) {
					BlockEntity blockEntity = world.getBlockEntity(pos);
					if (blockEntity != null)
						return blockEntity.getTileData().getDouble(tag);
				...
				if (!world.isClientSide()) {
					...
					if (_blockEntity != null)
						...
						}.getValue(world, new BlockPos(x, y, z), "temperature") + 75));
					if (world instanceof Level _level)
						_level.sendBlockUpdated(_bp, _bs, _bs, 3);
				}
			} else if (new Object() {
			...
			}.getValue(world, new BlockPos(x, y, z), "numOfUrandia") == 4 && new Object() {
				public double getValue(LevelAccessor world, BlockPos pos, String tag) {
					BlockEntity blockEntity = world.getBlockEntity(pos);
					if (blockEntity != null)
						return blockEntity.getTileData().getDouble(tag);
				...
				if (!world.isClientSide()) {
					...
					if (_blockEntity != null)
						...
						}.getValue(world, new BlockPos(x, y, z), "temperature") + 120));
					if (world instanceof Level _level)
						_level.sendBlockUpdated(_bp, _bs, _bs, 3);
				}
			} else if (new Object() {
