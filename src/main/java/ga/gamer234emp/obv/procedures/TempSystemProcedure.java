...
public class TempSystemProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((new Object() {
			...
			if (new Object() {
				...
				if (!world.isClientSide()) {
					...
					if (_blockEntity != null)
						_blockEntity.getTileData().putString("isActive", "no");
			...
			}.getFluidTankLevel(world, new BlockPos((int) x, (int) y, (int) z), 1) <= 2) {
				if (!world.isClientSide()) {
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					BlockEntity _blockEntity = world.getBlockEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
		...
		if (new Object() {
			...
			if (!world.isClientSide()) {
				...
				BlockState _bs = world.getBlockState(_bp);
				if (_blockEntity != null)
					_blockEntity.getTileData().putString("state", "hot");
				if (world instanceof Level _level)
					_level.sendBlockUpdated(_bp, _bs, _bs, 3);
			}
		} else if (new Object() {
			...
			if (!world.isClientSide()) {
				...
				BlockState _bs = world.getBlockState(_bp);
				if (_blockEntity != null)
					_blockEntity.getTileData().putString("state", "critical");
				if (world instanceof Level _level)
					_level.sendBlockUpdated(_bp, _bs, _bs, 3);
			}
		} else if (new Object() {
			...
			if (!world.isClientSide()) {
				...
				BlockState _bs = world.getBlockState(_bp);
				if (_blockEntity != null)
					_blockEntity.getTileData().putString("state", "meltdown");
				if (world instanceof Level _level)
					_level.sendBlockUpdated(_bp, _bs, _bs, 3);
			}
			{
				...
				Property<?> _property = _bs.getBlock().getStateDefinition().getProperty("MELT");
