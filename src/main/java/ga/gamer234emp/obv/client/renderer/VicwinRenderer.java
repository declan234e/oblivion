...
public class VicwinRenderer extends HumanoidMobRenderer<VicwinEntity, HumanoidModel<VicwinEntity>> {
	public VicwinRenderer(EntityRendererProvider.Context context) {
