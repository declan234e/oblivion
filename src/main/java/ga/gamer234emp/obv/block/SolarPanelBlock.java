...
import ga.gamer234emp.obv.procedures.SolarPanelUpdateTickProcedure;
...
public class SolarPanelBlock extends OblivionModElements.ModElement {
	@ObjectHolder("oblivion:solar_panel")
	public static final Block block = null;
	@ObjectHolder("oblivion:solar_panel")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public SolarPanelBlock(OblivionModElements instance) {
		super(instance, 59);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.GLASS).hardnessAndResistance(1.4000000000000001f, 10f).setLightLevel(s -> 0)
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 2.25, 16)
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		private final EnergyStorage energyStorage = new EnergyStorage(5000, 0, 200, 0) {
			@Override
