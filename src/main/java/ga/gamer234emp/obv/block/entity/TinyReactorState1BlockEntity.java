...
public class TinyReactorState1BlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(3, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public TinyReactorState1BlockEntity(BlockPos position, BlockState state) {
		super(OblivionModBlockEntities.TINY_REACTOR_STATE_1.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("tiny_reactor_state_1");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new TinyReactorGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return new TextComponent("Tiny Reactor ");
	}
