...
public class ModScreensHandler {
    ...
    public static ScreenHandlerType<TinyReactorScreenHandler> TINY_REACTOR_SCREEN_HANDLER = new ExtendedScreenHandlerType<>(TinyReactorScreenHandler::new);
    ...
    public static void registerAllScreenHandlers() {
        ...
        Registry.register(Registry.SCREEN_HANDLER, new Identifier(Oblivion.MOD_ID, "tiny_reactor_sh"), TINY_REACTOR_SCREEN_HANDLER);
        ...
        Oblivion.LOGGER.debug("Register Mod Screen Handlers for " + Oblivion.MOD_ID);
    }
