...
public class TempSystemProcedure extends AtlasMultiModElements.ModElement {
	public TempSystemProcedure(AtlasMultiModElements instance) {
		super(instance, 49);
	}
			...
			if (((new Object() {
				...
				if (!world.isRemote()) {
					...
					if (_tileEntity != null)
						...
						}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "temperature")) + 100));
