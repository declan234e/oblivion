...
package tas.atlas.entity;

import tas.atlas.entity.renderer.VicwinRenderer;
...
public class VicwinEntity extends AtlasMultiModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("vicwin").setRegistryName("vicwin");
	public VicwinEntity(AtlasMultiModElements instance) {
		super(instance, 81);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("vicwin_spawn_egg"));
	}
