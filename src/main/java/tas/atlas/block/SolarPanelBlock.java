...
import tas.atlas.procedures.SolarPanelUpdateTickProcedure;
...
public class SolarPanelBlock extends AtlasMultiModElements.ModElement {
	@ObjectHolder("atlas_multi:solar_panel")
	public static final Block block = null;
	@ObjectHolder("atlas_multi:solar_panel")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SolarPanelBlock(AtlasMultiModElements instance) {
		super(instance, 59);
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 2.25, 16)).withOffset(offset.x, offset.y, offset.z);
		}
