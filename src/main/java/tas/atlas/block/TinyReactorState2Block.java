...
import tas.atlas.procedures.TinyReactorUpdateTickProcedure;
import tas.atlas.procedures.TinyReactorState1BlockAddedProcedure;
import tas.atlas.itemgroup.ReactorsItemGroup;
import tas.atlas.gui.TinyReactorGuiGui;
...
public class TinyReactorState2Block extends AtlasMultiModElements.ModElement {
	@ObjectHolder("atlas_multi:tiny_reactor_state_2")
	public static final Block block = null;
	@ObjectHolder("atlas_multi:tiny_reactor_state_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public TinyReactorState2Block(AtlasMultiModElements instance) {
		super(instance, 53);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("tiny_reactor_state_2"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("tiny_reactor_state_2");
		}
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 5);
			{
				...
				TinyReactorState1BlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				TinyReactorUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 5);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("tiny_reactor_state_2");
		}
