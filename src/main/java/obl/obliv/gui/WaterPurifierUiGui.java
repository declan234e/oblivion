...
import obl.obliv.procedures.WaterPurifierUpdateTickProcedure;
...
public class WaterPurifierUiGui extends OblivionModElements.ModElement {
	...
	public WaterPurifierUiGui(OblivionModElements instance) {
		super(instance, 62);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				OblivionMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
